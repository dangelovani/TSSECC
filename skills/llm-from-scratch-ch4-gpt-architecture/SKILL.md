---
name: llm-from-scratch-ch4-gpt-architecture
description: Use when implementing GPT from scratch.
---
# Implementing GPT from Scratch (Raschka Ch 4)
